<template>
	<view class="product-con">
		...
		<view class='footer acea-row row-between-wrapper'>
			<view v-if="!isLogin" @click="this.$set(this, 'isShowAuth', true)">
				<view class="iconfont icon-kefu"></view>
				<view>客服</view>
			</view>
			<navigator v-else hover-class="none" class="item" :url="`/pages/chat/customer_list/chat?mer_id=${storeInfo.mer_id}&uid=${uid}&productId=${id}`">
				<view class="iconfont icon-kefu"></view>
				<view>客服</view>
			</navigator>
