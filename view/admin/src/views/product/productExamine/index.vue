...
<script>
import { changeApi, productLstApi, productDetailApi, categoryListApi, productUpdateApi, lstFilterApi, merSelectApi, productOffApi } from '@/api/product'
import { roterPre } from '@/settings'
import infoFrom from './info'
import ueditorFrom from '@/components/ueditorFrom'
const proOptions = [{ name: '热门榜单', value: 'is_hot' }, { name: '促销单品', value: 'is_benefit' }, { name: '精品推荐', value: 'is_best' }, { name: '优品推荐', value: 'is_good' }]
export default {
